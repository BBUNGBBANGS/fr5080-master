...
static const uint8_t ota_svc_uuid[UUID_SIZE_16] = OTA_SVC_UUID_DSP;
...
const gatt_attribute_t ota_svc_att_table[OTA_ATT_NB] =
{
    ...
    [OTA_ATT_IDX_CHAR_VALUE_VERSION_INFO]= { { UUID_SIZE_16, OTA_CHAR_UUID_VERSION_INFO_DSP },
    ...
    [OTA_ATT_IDX_CHAR_VALUE_NOTI] = { { UUID_SIZE_16, OTA_CHAR_UUID_NOTI_DSP },
        GATT_PROP_READ | GATT_PROP_NOTI, OTAS_NOTIFY_DATA_SIZE_DSP, NULL
    },
    ...
    [OTA_ATT_IDX_CHAR_VALUE_TX] = { { UUID_SIZE_16, OTA_CHAR_UUID_TX_DSP },
        GATT_PROP_READ, OTAS_MAX_DATA_SIZE_DSP, NULL
    },
    ...
    [OTA_ATT_IDX_CHAR_VALUE_RX] = { { UUID_SIZE_16, OTA_CHAR_UUID_RX_DSP },
        GATT_PROP_WRITE, OTAS_MAX_DATA_SIZE_DSP, NULL
    },
};
