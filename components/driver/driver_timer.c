 ...
 * @return  prescale.
 */
static uint8_t timer_calc_prescale1(uint32_t count_us)
{
    /*
        prescale: 1
 ...
 * @return  None.
 */
__attribute__((section("ram_code"))) void timer_run1(uint32_t timer_addr)
{
 ...
 * @return  None.
 */
__attribute__((section("ram_code"))) void timer_stop1(uint32_t timer_addr)
{
    volatile struct timer *timerp = (volatile struct timer *)timer_addr;
 ...
 * @return  None.
 */
void timer_reload1(uint32_t timer_addr)
{
    volatile struct timer *timerp = (volatile struct timer *)timer_addr;
 ...
 * @return  None.
 */
__attribute__((section("ram_code"))) void timer_clear_interrupt1(uint32_t timer_addr)
{
    volatile struct timer *timerp = (volatile struct timer *)timer_addr;
 ...
 */
uint32_t timer_get_current_value1(uint32_t timer_addr)
{
    volatile struct timer *timerp = (volatile struct timer *)timer_addr;
 ...
 */
uint32_t timer_get_load_value1(uint32_t timer_addr)
{
    volatile struct timer *timerp = (volatile struct timer *)timer_addr;
...
__attribute__((section("ram_code"))) void timer_set_load_value1(uint32_t timer_addr, uint32_t load_value)
{
    volatile struct timer *timerp = (volatile struct timer *)timer_addr;
 ...
 * @return  None.
 */
uint8_t timer_init1(uint32_t timer_addr, uint32_t count_us, uint8_t run_mode)
{
    uint8_t sysclk;
    uint16_t count;
    uint8_t prescale;
...
//    }
    ...
    prescale = timer_calc_prescale1(count_us);
    printf("prescale =%d   count_us = %d\r\n",prescale,count_us);
    if(prescale == TIMER_PRESCALE_MAX)
    {
        return false;
    }

    sysclk =48;// system_get_pclk_config();
